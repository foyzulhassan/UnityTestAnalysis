...
/**
 * Gradlepatch generated by hbm2java
 */
public class Gradlepatch implements java.io.Serializable {
	...
	public Gradlepatch(long row) {
		this.row = row;
	}

	public Gradlepatch(long row, String gitCommit, String ghProjectName, String gitBranch, String gitCommits,
